...
export const BADGES: Badges = {
  boosts: {
    ...
    booster_8: {
      ...
      icon: `/assets/images/icons/discord/badges/boost/discordboost8.svg`,
      description:
    ...
    booster_9: {
      ...
      icon: `/assets/images/icons/discord/badges/boost/discordboost9.svg`,
  ...
  bot: {
    supports_commands: {
      ...
      icon: `/assets/images/icons/discord/badges/bot/supportscommands.svg`,
      description: "Bot must use application commands to earn this badge.",
      bitwise: 524288, 
    },
    uses_automod: {
      name: "Uses Automod",
      icon: `/assets/images/icons/discord/badges/bot/automod.svg`,
      description: "100 active automod rules created.",
      bitwise: 1 << 24, 
    },
    premium_app: {
      name: "This server has App Name premium",
      icon: `/assets/images/icons/discord/badges/bot/premiumbot.png`,
      description:
  ...
  flairs: {
    official: {
      name: "Official",
      icon: `/assets/images/icons/discord/badges/flairs/Official.svg`,
      description:
    ...
    system: {
      name: "System",
      icon: `/assets/images/icons/discord/badges/flairs/System.svg`,
      description: "Reserved for discord system or automod messages. (Old)",
      bitwise: null,
    },
    server: {
      name: "Server",
      icon: `/assets/images/icons/discord/badges/flairs/Server.svg`,
      description: 'Reserved by a "webhook" by following a channel.',
      bitwise: null,
    },
    verified_bot_app: {
      name: "Verified Bot/App",
      icon: `/assets/images/icons/discord/badges/flairs/VerifiedBot.svg`,
      description: "Obtained by a verified app.",
      bitwise: null,
    },
    bot_app: {
      name: "Bot/App",
      icon: `/assets/images/icons/discord/badges/flairs/Bot.svg`,
      description: "Obtained by an unverified app.",
      bitwise: null,
    },
    beta: {
      name: "Beta",
      icon: `/assets/images/icons/discord/badges/flairs/Beta.svg`,
      description: "Reserved for in beta features (Also off center).",
      bitwise: null,
    },
    ai: {
      name: "Ai",
      icon: `/assets/images/icons/discord/badges/flairs/LightAi.svg`,
      description: "Only for the Clyde Ai bot.",
      bitwise: null,
    },
    original_poster: {
      name: "Original Poster",
      icon: `/assets/images/icons/discord/badges/flairs/OriginalPoster.svg`,
      description: "Given to the original poster of a forum post.",
      bitwise: null,
    },
    app: {
      name: "App",
      icon: `/assets/images/icons/discord/badges/flairs/App.svg`,
    ...
    verified_app: {
      name: "Verified App",
      icon: `/assets/images/icons/discord/badges/flairs/VerifiedApp.svg`,
  ...
  general: {
    active_developer: {
      ...
      icon: `/assets/images/icons/discord/badges/general/activedeveloper.svg`,
      description:
    ...
    discordbotdev: {
      ...
      icon: `/assets/images/icons/discord/badges/general/discordbotdev.svg`,
      description: "Owned a verified Discord bot before August 19, 2020.",
      bitwise: 131072, 
    },
    discordbughunter1: {
      name: "Discord Bug Hunter (Tier 1)",
      icon: `/assets/images/icons/discord/badges/general/discordbughunter1.svg`,
      description: "Bug Hunter Level 1",
      bitwise: 8, 
    },
    discordbughunter2: {
      name: "Discord Bug Hunter (Tier 2)",
      icon: `/assets/images/icons/discord/badges/general/discordbughunter2.svg`,
      description: "Bug Hunter Level 2",
      bitwise: 16384, 
    },
    discordearysupporter: {
      name: "Early Supporter",
      icon: `/assets/images/icons/discord/badges/general/discordearlysupporter.svg`,
      description: "Had a successful transaction before October 10, 2018.",
      bitwise: 512, 
    },
    discordlootbox: {
      name: "A clown, for a limited time",
      icon: `/assets/images/icons/discord/badges/general/discordlootbox.svg`,
      description:
    ...
    discordmod: {
      ...
      icon: `/assets/images/icons/discord/badges/general/discordmod.svg`,
      description: "No longer obtainable after Dec 1, 2022.",
      bitwise: 262144, 
    },
    discordnitro: {
      name: "Discord Nitro (Multiple Tiers)",
      icon: `/assets/images/icons/discord/badges/general/discordnitro.svg`,
      description:
    ...
    discordpartner: {
      ...
      icon: `/assets/images/icons/discord/badges/general/discordpartner.svg`,
      description: "Owned a partnered server before Oct 5, 2023.",
      bitwise: 2, 
    },
    discordstaff: {
      name: "Discord Staff",
      icon: `/assets/images/icons/discord/badges/general/discordstaff.svg`,
      description: "Being a Discord employee.",
      bitwise: 1, 
    },
    hypesquadbalance: {
      name: "HypeSquad Balance",
      icon: `/assets/images/icons/discord/badges/general/hypesquadbalance.svg`,
      description: "HypeSquad Balance house member.",
      bitwise: 256, 
    },
    hypesquadbravery: {
      name: "HypeSquad Bravery",
      icon: `/assets/images/icons/discord/badges/general/hypesquadbravery.svg`,
      description: "HypeSquad Bravery house member.",
      bitwise: 64, 
    },
    hypesquadbrilliance: {
      name: "HypeSquad Brilliance",
      icon: `/assets/images/icons/discord/badges/general/hypesquadbrilliance.svg`,
      description: "HypeSquad Brilliance house member.",
      bitwise: 128, 
    },
    hypesquadevents: {
      name: "HypeSquad Events",
      icon: `/assets/images/icons/discord/badges/general/hypesquadevents.svg`,
      description: "HypeSquad event attendance (closed, no longer obtainable).",
      bitwise: 4, 
    },
    orb: {
      name: "Orbs",
      icon: `/assets/images/icons/discord/badges/general/orb.svg`,
      description: "Complete quests and purchase from Orbs Exclusives shop.",
      bitwise: null,
    },
    quest: {
      name: "Completed a Quest",
      icon: `/assets/images/icons/discord/badges/general/quest.svg`,
      description: "Completed a quest from gift inventory tab.",
      bitwise: null,
    },
    username: {
      name: "Originally Known As",
      icon: `/assets/images/icons/discord/badges/general/username.png`,
  ...
  nitro: {
    bronze: {
      name: "Bronze",
      icon: `/assets/images/icons/discord/badges/nitro/bronze.png`,
      description: "Subscribing to Nitro for 1 month.",
      bitwise: null,
    },
    silver: {
      name: "Silver",
      icon: `/assets/images/icons/discord/badges/nitro/silver.png`,
      description: "Subscribing to Nitro for 3 months.",
      bitwise: null,
    },
    gold: {
      name: "Gold",
      icon: `/assets/images/icons/discord/badges/nitro/gold.png`,
      description: "Subscribing to Nitro for 6 months.",
      bitwise: null,
    },
    platinum: {
      name: "Platinum",
      icon: `/assets/images/icons/discord/badges/nitro/platinum.png`,
      description: "Subscribing to Nitro for 12 months (1 year).",
      bitwise: null,
    },
    diamond: {
      name: "Diamond",
      icon: `/assets/images/icons/discord/badges/nitro/diamond.png`,
      description: "Subscribing to Nitro for 24 months (2 years).",
      bitwise: null,
    },
    emerald: {
      name: "Emerald",
      icon: `/assets/images/icons/discord/badges/nitro/emerald.png`,
      description: "Subscribing to Nitro for 36 months (3 years).",
      bitwise: null,
    },
    ruby: {
      name: "Ruby",
      icon: `/assets/images/icons/discord/badges/nitro/ruby.png`,
      description: "Subscribing to Nitro for 60 months (5 years).",
      bitwise: null,
    },
    opal: {
      name: "Opal",
      icon: `/assets/images/icons/discord/badges/nitro/opal.png`,
